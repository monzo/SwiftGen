...
extension Strings {
  struct Entry {
    ...
    init(key: String, translation: String, types: [PlaceholderType], parameters: [Parameter], keyStructureSeparator: String) {
      self.key = key
    ...
    init(key: String, translation: String, keyStructureSeparator: String) throws {
      ...
      self.init(key: key, translation: translation, types: types, parameters: parameters, keyStructureSeparator: keyStructureSeparator)
    }
